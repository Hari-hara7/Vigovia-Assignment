          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
            ...
            <div className="text-right">
              <div className="bg-purple-800 text-white p-4 rounded-lg mb-4 inline-block">
                ...
                <p className="text-sm font-bold">+91-98xxx64841</p>
              </div>
              ...
              <div className="text-xs text-gray-700 text-right">
                ...
                <p className="text-xs leading-relaxed text-gray-600">
                  HO-109 Girinagar Hills,Links Business<br/>
                  Park,Bangalore<br/>
...
<div className="flex flex-col items-center justify-center text-center">
  ...
  <div className="flex gap-3 justify-center">
    <div className="bg-blue-600 text-white px-4 py-2 rounded text-xs font-medium">
      Razorpay
    </div>
    <div className="bg-blue-800 text-white px-4 py-2 rounded text-xs font-medium">
      stripe
    </div>
  </div>
</div>
